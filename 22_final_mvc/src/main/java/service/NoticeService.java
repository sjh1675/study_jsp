...
public interface NoticeService {
	...
	// 게시글 목록
	/**
	 * @param request - 게시글 목록을 호출 하기 위한 정보 전달 - page
	 *                - 목록 검색 후 request에 리스트 정보 저장 - key name : noticeList
	...
	// 게시글 상세보기
	/**
	 * @param request - 한개의 게시글 상세보기를 위한 정보를 전달 - 게시물 번호
	 *                - 목록 검색 후 request에 리스트 정보 저장 - key name : notice
	 */
